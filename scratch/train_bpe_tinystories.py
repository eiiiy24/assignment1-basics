...
if __name__ == '__main__':
    ...
    train_path = PROJECT_DIR / "data" / "TinyStoriesV2-GPT4-train.txt"
    ...
    # 反序列化
    # with open(output_dir / "tinystories_vocab.json") as f:
    #     json_vocab = json.load(f)
    # vocab = {int(k): bytes(v["bytes"]) for k, v in json_vocab.items()}
    # with open(output_dir / "tinystories_merges.json") as f:
